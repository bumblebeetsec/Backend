...
def get_scholarship(request):
    ...
    for scholarship in all_scholarships:
        scholarship_entry = {"id": scholarship.id, "name": scholarship.name, "organisation_name": scholarship.organisation.name, "description": scholarship.scholarship_description[:30]}
